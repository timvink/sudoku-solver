...
__all__ = ["single_candidates","single_position","candidate_lines","double_pairs","naked_pairs","naked_triples","naked_quads","hidden_pairs","multiple_lines","hidden_triples"]
