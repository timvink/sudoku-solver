...
def test_find_hidden_triples():
    ...
    row.cells[1].value = 9; row.cells[1].markup = set()
    row.cells[2].markup = {1,8}
    row.cells[3].markup = {3,4,7}
    row.cells[4].value = 2; row.cells[4].markup = set()
    ...
    assert row.cells[0].markup == {3,4,7}  # Remove 1, add 4
    ...
    row.cells[6].value = 4; row.cells[6].markup = set()
    ...
    assert row.cells[7].markup == {1,3,9}  # Remove 7,8 